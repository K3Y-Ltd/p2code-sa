...
def hilbert_point(dimension, order, h):
    ...
    h : int
        The index on the Hilbert curve.

    Returns
    -------
    List[int]
        A location in the cube in n-dimensions 
    """
...
class Hilbert:
    """
    A class representing an n-dimensional(?) hilbert curve.
    """
    ...
    def fromSize(self, dimension, size):
        ...
        # Order is the number of bits per dimension?
